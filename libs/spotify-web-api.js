...
var SpotifyWebApi = (function () {
  ...
  var _performRequest = function (requestData, callback) {
    ...
    var promiseFunction = function (resolve, reject) {
	  ...
	  if (_bearer) { //nathan
		...
		req.setRequestHeader('Authorization', 'Basic ' + _accessCode);
		_bearer = true;
      }
  ...
  /*BIG TEST*/
  Constr.prototype.getAuthToken = function (redirecturi, accessCode, callback) {
	var redirect_uri = encodeURIComponent(redirecturi);
	_bearer = false;
    var requestData = {
		type: 'POST',
		url: "https://accounts.spotify.com/api/token?grant_type=authorization_code&code="+accessCode+"&redirect_uri="+redirect_uri,
		contentType: 'application/x-www-form-urlencoded'
	};
    return _checkParamsAndPerformRequest(requestData, callback);
  };
  
  Constr.prototype.refreshAuthToken = function (redirecturi, refreshToken, callback) {
	var redirect_uri = encodeURIComponent(redirecturi);
	_bearer = false;
    var requestData = {
		type: 'POST',
  ...
  Constr.prototype.setClientCode = function (clientID, clientSecret) {
    _accessCode = window.btoa(clientID + ":" + clientSecret);
  };
